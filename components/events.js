...
export default [
  ...
  },
  {
    id: 6,
    title: 'Lunch',
    start: new Date(2024, 1, 12, 10, 0, 0, 0),
    end: new Date(2024, 1, 12, 11, 0, 0, 0),
    desc: 'Power lunch',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    start: new Date(2024, 1, 13, 9, 30, 0),
    end: new Date(2024, 1, 13, 12, 0, 0),
  },
  {
    id: 11.2,
  ...
  },
  {
    ...
    start: new Date(2024, 1, 13, 15, 30, 0),
    end: new Date(2024, 1, 13, 16, 0, 0),
  },
  {
    id: 12,
    title: 'Late Night Event',
    start: new Date(2024, 1, 17, 19, 30, 0),
    end: new Date(2024, 1, 18, 2, 0, 0),
  },
  {
    id: 12.5,
    title: 'Late Same Night Event',
    start: new Date(2024, 1, 17, 19, 30, 0),
    end: new Date(2024, 1, 17, 23, 30, 0),
  },
  {
    id: 13,
    title: 'Multi-day Event',
    start: new Date(2024, 1, 20, 19, 30, 0),
  ...
  },
  {
    id: 16,
    title: 'Video Record',
    start: new Date(2024, 1, 14, 15, 30, 0),
    end: new Date(2024, 1, 14, 19, 0, 0),
  },
  {
    id: 17,
    title: 'Dutch Song Producing',
    start: new Date(2024, 1, 14, 16, 30, 0),
    end: new Date(2024, 1, 14, 20, 0, 0),
  },
  {
    id: 18,
    title: 'Itaewon Meeting',
    start: new Date(2024, 1, 14, 16, 30, 0),
    end: new Date(2024, 1, 14, 17, 30, 0),
  },
  {
    id: 19,
    title: 'Online Coding Test',
    start: new Date(2024, 1, 14, 17, 30, 0),
    end: new Date(2024, 1, 14, 20, 30, 0),
  },
  {
    id: 20,
    title: 'An overlapped Event',
    start: new Date(2024, 1, 14, 17, 0, 0),
    end: new Date(2024, 1, 14, 18, 30, 0),
  },
  {
    id: 21,
  ...
  },
  {
    id: 23,
    title: 'Go to the gym',
    start: new Date(2024, 1, 14, 18, 30, 0),
    end: new Date(2024, 1, 14, 20, 0, 0),
  },
  {
    id: 24,
